...
import { summarySaga } from '../features/summary/saga';
import { deadLetterSaga, offlineBootSaga } from '../offline/connectivitySaga';
import { syncSaga } from '../offline/syncSaga';
...
export function* rootSaga() {
  yield all([
    fork(referenceSaga),
    fork(inspectionsSaga),
    fork(summarySaga),
    fork(syncSaga),
    fork(deadLetterSaga),
    fork(offlineBootSaga),
  ]);
}
